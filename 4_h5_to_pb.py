...
parser.add_argument('-h5_model',default="./weights/yolov8n.h5", help='Path to h5 model file.')
parser.add_argument('-pb_model',default="./weights/yolov8n.pb",help='Path to pb model file.')
